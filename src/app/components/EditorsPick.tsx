...
const EditorsPick = () => {
    return (
        <div className='bg-[#FAFAFA]  py-20 px-2 '>
            ...
            <div className="flex flex-col lg:flex-row text-center justify-center items-center gap-6 mt-6">
                ...
                <div className='relative'>
                    <img src="/men.png" alt="men-cloths" className='h-[500px] w-[324px] lg:w-[510px]' />
                    <button className='w-[170px] max-h-[48px] bg-white absolute bottom-8 left-8 font-bold'>MEN</button>
                </div>
                <div className='flex flex-col lg:flex-row gap-6  '>
                    <div className='relative'>
                        <img src="/women.png" alt="women-cloths" className='h-[500px] w-[324px] lg:w-[240px]' />
                    ...
                    <div className='flex flex-col h-[500px]  justify-between'>
                        <div className='relative'>
                            <img src="/accessories.png" alt="accessories" className='h-[242px] w-[324px] lg:w-[240px]' />
                            <button className='w-[170px] h-[48px] bg-white absolute bottom-8 left-8 font-bold'>accessories</button>
                        </div>
                        <div className='relative'>
                            <img src="/kids.png" alt="kids" className='h-[242px]  w-[324px] lg:w-[240px]' />
            ...
            {/* <img src="/women.png" alt="women-cloths" className='h-[500px] w-[324px]' /> */}
